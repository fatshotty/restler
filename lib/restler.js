...
function Request(uri, options) {
  ...
  if (options.socket) {
    http_client_options.socketPath = options.socket;
    delete http_client_options.host;
    delete http_client_options.port;
  }

  this.request = proto.request( http_client_options );
